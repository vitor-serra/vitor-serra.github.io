...
const register_ply_pointcloud_model = function() {
    AFRAME.registerComponent('ply-pointcloud-model', {
        schema: {
            src: {type: 'asset'},
            pointSize: {type: 'number', default: 1.0}
        },
        ...
        loadPLY: function () {
            ...
            let point_size = this.data.pointSize
            let el = this.el;
            ...
            loader.load(src,
	                    ...
	                    function ( error ) {
		                    console.log( "Error while loading PLY: " + error );
	                    }
                       )
        }
    });
